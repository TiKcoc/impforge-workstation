...
const MODULE_MAP: Record<string, string[]> = {
	developer:    ['home', 'chat', 'github', 'docker', 'workflows', 'ide', 'agents', 'evaluation', 'ai', 'router', 'browser', 'news', 'social', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'connector', 'apps', 'health', 'settings'],
	...
	custom:       ['home', 'chat', 'github', 'docker', 'workflows', 'ide', 'agents', 'evaluation', 'ai', 'router', 'browser', 'news', 'social', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'connector', 'apps', 'health', 'settings'],
};
