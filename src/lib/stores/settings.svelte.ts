...
const MODULE_MAP: Record<string, string[]> = {
	developer:    ['home', 'chat', 'github', 'docker', 'n8n', 'ide', 'agents', 'evaluation', 'ai', 'browser', 'news', 'social', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'apps', 'settings'],
	...
	entrepreneur: ['home', 'chat', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'agents', 'browser', 'news', 'social', 'apps', 'settings'],
	custom:       ['home', 'chat', 'github', 'docker', 'n8n', 'ide', 'agents', 'evaluation', 'ai', 'browser', 'news', 'social', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'apps', 'settings'],
};
