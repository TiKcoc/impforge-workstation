...
const MODULE_MAP: Record<string, string[]> = {
	developer:    ['home', 'chat', 'github', 'docker', 'n8n', 'ide', 'agents', 'evaluation', 'ai', 'browser', 'news', 'social', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'connector', 'apps', 'settings'],
	office:       ['home', 'chat', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'news', 'apps', 'settings'],
	freelancer:   ['home', 'chat', 'github', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'browser', 'news', 'social', 'apps', 'settings'],
	...
	entrepreneur: ['home', 'chat', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'agents', 'browser', 'news', 'social', 'connector', 'apps', 'settings'],
	custom:       ['home', 'chat', 'github', 'docker', 'n8n', 'ide', 'agents', 'evaluation', 'ai', 'browser', 'news', 'social', 'writer', 'notes', 'sheets', 'slides', 'pdf', 'canvas', 'mail', 'team', 'calendar', 'import', 'files', 'freelancer', 'platforms', 'connector', 'apps', 'settings'],
};
