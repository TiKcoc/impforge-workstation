...
const MODULE_MAP: Record<string, string[]> = {
	developer:    ['home', 'chat', 'github', 'docker', 'n8n', 'ide', 'agents', 'evaluation', 'ai', 'browser', 'news', 'social', 'writer', 'sheets', 'pdf', 'freelancer', 'platforms', 'apps', 'settings'],
	office:       ['home', 'chat', 'writer', 'sheets', 'pdf', 'news', 'apps', 'settings'],
	freelancer:   ['home', 'chat', 'github', 'writer', 'sheets', 'pdf', 'freelancer', 'platforms', 'browser', 'news', 'social', 'apps', 'settings'],
	manager:      ['home', 'chat', 'writer', 'sheets', 'pdf', 'agents', 'evaluation', 'news', 'apps', 'settings'],
	marketing:    ['home', 'chat', 'writer', 'sheets', 'pdf', 'browser', 'news', 'social', 'platforms', 'apps', 'settings'],
	student:      ['home', 'chat', 'writer', 'sheets', 'pdf', 'ide', 'ai', 'news', 'apps', 'settings'],
	entrepreneur: ['home', 'chat', 'writer', 'sheets', 'pdf', 'freelancer', 'platforms', 'agents', 'browser', 'news', 'social', 'apps', 'settings'],
	custom:       ['home', 'chat', 'github', 'docker', 'n8n', 'ide', 'agents', 'evaluation', 'ai', 'browser', 'news', 'social', 'writer', 'sheets', 'pdf', 'freelancer', 'platforms', 'apps', 'settings'],
};
