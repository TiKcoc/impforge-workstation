...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            forge_sheets::sheets_add_agentic_cell,
            forge_sheets::sheets_refresh_agentic,
            forge_sheets::sheets_list_agentic,
            forge_sheets::sheets_remove_agentic,
            forge_sheets::sheets_ai_chart,
            forge_sheets::sheets_add_chart,
            forge_sheets::sheets_remove_chart,
            forge_sheets::sheets_pivot,
            forge_sheets::sheets_add_conditional_format,
            forge_sheets::sheets_remove_conditional_format,
            forge_sheets::sheets_eval_conditional_formats,
            forge_sheets::sheets_add_data_validation,
            ...
            forge_quest::swarm_collect_resources,
            forge_quest::swarm_start_research,
            forge_quest::swarm_build_ships,
            forge_quest::swarm_get_fleet,
            forge_quest::swarm_get_research,
            forge_quest::swarm_get_creep,
            forge_quest::swarm_shop_items,
